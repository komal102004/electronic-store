...
public class ProductController {
    ...
    public ResponseEntity<ImageResponse> uploadProductImage(
       ...
       ProductDto updatedProduct= productService.update(productDto,productId);
      ImageResponse response= ImageResponse.builder().message("Product image '" + updatedProduct.getProductImageName() + "' is successfully uploaded ! !").status(HttpStatus.CREATED).success(true).build();
